...
import cloudLoginOut from "../../../API/request/user/loginOut";
import updateUser from "../../../API/request/user/updateUser";
import updateUserEmail from "../../../API/request/user/updateUserEmail";
import updateUserAvater from "../../../API/request/user/updateUserAvater";
        ...
        if (!buf) {
            ...
            updateUserAvater({file,filename}).then(res=>{
                if (res.success) {
                    ...
                    this.props.message('修改头像失败'+res.message);
                }
            });
            /*
